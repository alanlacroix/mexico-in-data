...
// Remote guard preserved (2026-08-01): the Mexico overview entry stays out of the
// Quarterly review menu; it was removed deliberately upstream.
if (menuLinks.some((href) => /overview/i.test(href))) fail('the Quarterly review dropdown must not include Mexico overview');
...
// Retired route aliases are still checked below.
