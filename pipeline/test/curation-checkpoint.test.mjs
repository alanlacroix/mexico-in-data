...
const receipt = {
  policy: 'edition-window-assessment-v3',
...
assert.equal(canReuseCuration(receipt, '2026-08-18', candidateSignature(morning), 'edition-window-assessment-v3'), true);
assert.equal(canReuseCuration({ ...receipt, policy: 'edition-window-assessment-v2' }, '2026-08-18', candidateSignature(morning), 'edition-window-assessment-v3'), false,
