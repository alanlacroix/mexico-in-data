...
const morningReceipt = { pipelineVersion: PIPELINE_VERSION, editorialDate: '2026-07-31', slot: 'morning', publicationId: 'run-1' };
...
result = decide('2026-07-31T13:37:00Z', {
  status: { ...morningReceipt, pipelineVersion: 1 },
});
...
const legacyReceipt = { pipelineVersion: PIPELINE_VERSION, editorialDate: '2026-07-31', slot: 'afternoon', publicationId: 'run-2' };
