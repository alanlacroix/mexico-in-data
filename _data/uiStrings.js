...
module.exports = {
  en: {
    ...
    stories: 'Key developments', storyCount: (n, latest) => `${n} ${n === 1 ? 'story' : 'stories'}${latest ? ` · latest ${latest}` : ''}`,
  ...
  es: {
    ...
    stories: 'Historias clave', storyCount: (n, latest) => `${n} ${n === 1 ? 'historia' : 'historias'}${latest ? ` · última ${latest}` : ''}`,
