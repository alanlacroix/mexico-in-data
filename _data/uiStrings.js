...
module.exports = {
  en: {
    ...
    week: 'This week', weekSub: 'if you missed the week', all: 'All', showMoreTpl: 'Show {n} more',
  ...
  es: {
    ...
    week: 'Esta semana', weekSub: 'si te perdiste la semana', all: 'Todas', showMoreTpl: 'Ver {n} más',
